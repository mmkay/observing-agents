...
## Traces can contain full prompts, tool outputs, and raw API bodies.
...
Privacy is important too. If you want to store the prompts, then it's good to make sure they are available only to you.